function  T0T24=T_0_24(Q,L)

t1=Q(1);t2=Q(2);t3=Q(3);t4=Q(4);t5=Q(5);t6=Q(6);
t15=Q(13);t21=Q(17);t22=Q(18);t23=Q(19);
...
% 
% 
%    Name of file : C:\Users\Toshiba\Desktop\Bibliography\Gait analysis\3D model figures\symoro entry file updated\T_0_24.fgm
% 
% 
% 
% 
...
% 
% 
%   Transformation Matrix From  R 0  to  R  24 :
% -------------------------------------------
% Equations:
...
U1T1011=U1T512*cos(t21) - U1T911*sin(t21);
U1T1012=-(U1T911*cos(t21)) - U1T512*sin(t21);
U1T1014=L8*U1T911 + U1T914;
U1T1021=U1T522*cos(t21) - U1T921*sin(t21);
U1T1022=-(U1T921*cos(t21)) - U1T522*sin(t21);
U1T1024=L8*U1T921 + U1T924;
U1T1031=U1T532*cos(t21) - U1T931*sin(t21);
U1T1032=-(U1T931*cos(t21)) - U1T532*sin(t21);
U1T1034=L8*U1T931 + U1T934;
U13T14=-(L9*cos(t22)) - L10*cos(t22 + t23);
U13T34=-(L9*sin(t22)) - L10*sin(t22 + t23);
U1T1311=U1T1011*cos(t22 + t23) - U1T912*sin(t22 + t23);
U1T1312=-(U1T912*cos(t22 + t23)) - U1T1011*sin(t22 + t23);
U1T1314=U13T14*U1T1011 + U1T1014 - U13T34*U1T912;
U1T1321=U1T1021*cos(t22 + t23) - U1T922*sin(t22 + t23);
U1T1322=-(U1T922*cos(t22 + t23)) - U1T1021*sin(t22 + t23);
U1T1324=U13T14*U1T1021 + U1T1024 - U13T34*U1T922;
U1T1331=U1T1031*cos(t22 + t23) - U1T932*sin(t22 + t23);
U1T1332=-(U1T932*cos(t22 + t23)) - U1T1031*sin(t22 + t23);
...
T0T24=[T0T2411 T0T2412 T0T2413 T0T2414;
 T0T2421 T0T2422 T0T2423 T0T2424;
 T0T2431 T0T2432 T0T2433 T0T2434];
