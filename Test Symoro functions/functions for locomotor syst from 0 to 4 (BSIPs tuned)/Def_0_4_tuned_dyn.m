...
%    Name of file : D:\The`se\3D_simulation\Test Symoro functions\functions for locomotor syst from 0 to 4 (BSIPs tuned)\Def_0_4_tuned.dyn
...
function [F_foot, M_foot, Torque] = Def_0_4_tuned_dyn(Q, QD, QDD, OVDotO,OWDotO,OWO)
...
%/* Parameters Joint 2 */ 
 ...
 MX2  =   -0.0386149516235616;
 MY2  = 0.0976881557629173;
 MZ2  =   -0.00664893206763312;
...
%/* Parameters Joint 4 */ 
 M4  =  20; % doit mettre une masse ici
...
% Function description:
	...
	U321=DV231 + WP11;
	U331=DV111 + DV221;
	VSP11=0 + VPX0 - L1.*(WPY0 + WX0.*WZ0) + L2.*(-WY0.^2 - WZ0.^2);
...
Torque(1,:) = GAM1;
	...
	M_foot(3,:) = N30;
% *=*
% Number of operations : 225 '+' or '-', 240 '*' or '/'
end