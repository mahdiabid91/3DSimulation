...
%    Name of file : C:\Users\Toshiba\Desktop\Bibliography\Gait analysis\3D model figures\symoro entry file frames 0 to 4\IDM\Def_0_4_mobile.dyn
...
function [F_foot, M_foot, Torque]=Def_0_4_mobile_dyn(Q, QD, QDD, OVDotO,OWDotO,OWO)
...
% *=*
% Number of operations : 188 '+' or '-', 210 '*' or '/'
end